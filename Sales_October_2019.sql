...
WHERE TABLE_NAME = 'Sales_October_2019' 
...
SELECT COUNT(*) FROM Sales_October_2019
...
SELECT DISTINCT Product FROM Sales_October_2019
...
SELECT Product, MIN(Price_Each) Max_Price, 
	MAX(Price_Each) AS Min_Price FROM Sales_October_2019
	group by Product
...
UPDATE Sales_October_2019
SET Order_Date = CAST(Order_Date AS smalldatetime) FROM Sales_October_2019
...
UPDATE Sales_October_2019
SET Month_Number = MONTH(Order_Date) FROM Sales_October_2019

--- explore to know the months
SELECT Month_Number AS MONTH FROM Sales_October_2019
...
SELECT DISTINCT State_Name FROM Sales_October_2019

----  check if the pincode IS neat and clean
SELECT Pincode FROM Sales_October_2019
